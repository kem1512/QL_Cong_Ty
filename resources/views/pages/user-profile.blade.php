                ...
                <div class="col-auto my-auto">
                    <div class="h-100">
                        ...
                        <p class="mb-0 font-weight-bold text-sm">
                            {{ Auth::user() -> position_id ?? 'Chưa có chức vụ'}}
                        </p>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="username" value="{{ old('Full Name', auth()->user()->fullname) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Mã Nhân Sự</label>
                                        <input class="form-control" type="text" name="lastname" value="{{ old('Personnel code', auth()->user()->personnel_code) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="firstname"  value="{{ old('Phone', auth()->user()->phone) }}">
                                    </div>
                                </div>
                ...
                <div class="card card-profile">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="text-center mt-4">
                            <h5>
                                {{ old('postal', auth()->user()->fullname ?? 'Chưa có tên') }} <span class="font-weight-light">, 35</span>
                            </h5>
